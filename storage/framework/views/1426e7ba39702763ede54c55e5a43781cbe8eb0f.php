...
<head>
  ...
  <link rel="icon" href="website/images/logo/logo.jpg" type="image/x-icon" />
                  ...
                  <div class="range range-10 range-md-center range-md-middle range-lg-around">
                    <div class="cell-md-3">
                      <div class="unit unit-horizontal unit-top unit-spacing-xs">
                        ...
                        <div class="unit-body">
                          <a class="reveal-block" href="website/tel:#">+977-9851026668,</a><a href="website/tel:#">+977-9815356075,</a>
                        </div>
                      </div>
                    </div>
                    <div class="cell-md-3 text-center">
                      <div class="rd-navbar-brand">
                        <a class="reveal-inline-block" href="website/index.html"><img src="website/images/logo/logo.jpg" alt=""
                ...
                <div class="rd-navbar-mobile-scroll">
                  <div class="rd-navbar-mobile-header-wrap">
                    <div class="rd-navbar-mobile-brand">
                      <a href="website/index.html"><img src="website/images/logo-default-2-144x122-1.png" alt=""
                          srcset="website/images/logo-default-2-144x122-1.png 2x" /></a>
                    </div>
                  </div>
                  <ul class="rd-navbar-nav">
                    ...
                    <li>
                      ...
                      <ul class="rd-navbar-dropdown">
                        ...
                        <li><a href="website/mission.html">Mission/Vision</a></li>
                        <li><a href="website/why-fortune.html">Why Fortune?</a></li>
                      </ul>
                    </li>
                    <li class="rd-navbar--has-dropdown rd-navbar-submenu">
                      <a href="/services">Services</a>
                      <ul class="rd-navbar-dropdown rd-navbar-open-right" ">
                        <li><a href="website/ career-council.html">Career Counselling</a>
                    </li>
                    <li>
                      <a href="website/language-class.html">Language Class By Experts</a>
                    </li>
                    <li>
                      <a href="website/about-education.html">About Educational Institution</a>
                    </li>
                    <li>
                      <a href="website/document-assistancs.html">Document Assistance</a>
                    </li>
                  </ul>
                  </li>
                  <li class="rd-navbar--has-dropdown rd-navbar-submenu">
                    ...
                    <ul class="rd-navbar-dropdown rd-navbar-open-right" ">
                        <li>
                          <a href="website/ abroad-study-country.html">USA</a>
                  </li>

                  <li>
                    <a href="website/abroad-study-country.html">Australia</a>
                  </li>
                  <li>
                    <a href="website/abroad-study-country.html">New Zealand</a>
                  </li>
                  <li>
                    <a href="website/abroad-study-country.html">Canada</a>
                  </li>
                  <li>
                    <a href="website/abroad-study-country.html">China</a>
                  </li>
                  ...
                  <li>
                    <a href="/testprepration">Test Prepration</a>
                    <ul class="rd-navbar-dropdown">
                      <li><a href="website/toelf.html">TOELF</a></li>
                      <li><a href="website/ielts.html">IELTS</a></li>
                      <li><a href="website/sat.html">SAT</a></li>
                      <li><a href="website/gre.html">GRE</a></li>
                      <li><a href="website/gmat.html">GMAT</a></li>
                      <li>
                        <a href="website/various-test.html">Various Tests High Scores</a>
                      </li>
          ...
          <div class="shell">
            <div class="range range-50 range-lg-justify range-xs-center">
              <div class="cell-md-3 cell-lg-3">
                <a class="footerLogo" href="website/index.html">
                  <img src="website/images/logo/logo.jpg" alt="" srcset="images/logo/logo.jpg" /></a>
                <div class="offset-top-30 text-center">
                  <ul class="list-inline list-inline-xs list-inline-madison">
                    <li>
                      <a class="icon novi-icon icon-xxs fa-facebook icon-circle icon-gray-light-filled" href="website/#"></a>
                    </li>
                    <li>
                      <a class="icon novi-icon icon-xxs fa-twitter icon-circle icon-gray-light-filled" href="website/#"></a>
                    </li>

                    <li>
                      <a class="icon novi-icon icon-xxs fa-instagram icon-circle icon-gray-light-filled" href="website/#"></a>
                    </li>
                  </ul>
                </div>
              </div>
                  ...
                  <ul class="list-unstyled contact-info list">
                    <li>
                      <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                        ...
                        <div class="unit-body">
                          <a class="text-dark" href="website/tel:#">+977-9851026668, ,</a><a
                            class="reveal-block reveal-md-inline-block text-dark" href="website/tel:#">+977-9815356075,</a>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                        ...
                        <div class="unit-body text-left">
                          <a class="text-dark" href="website/#">Bagbazar-2,Kathnandu ,Napal
                          </a>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                        ...
                        <div class="unit-body">
                          <a href="website/mailto:#">fortune100.edu.np@gmail.com </a>
                        </div>
                      </div>
                    </li>
                  </ul>
                    ...
                    <div class="form-group">
                      <div class="input-group input-group-sm">
                        <label class="form-label" for="form-email">Your e-mail</label><input class="form-control"
                          id="form-email" type="email" name="email"  /><span
        ...
        <div class="section-5 bg-madison context-dark novi-background">
          <div class="shell text-md-left">
            <p class="">
              ...
              Terms of Use and <a href="website/privacy.html">Privacy Policy.</a><span> Design&nbsp;by Radiant InfoTech
                Nepal</span>
            </p>
          </div>
        </div>
...
</html><?php /**PATH C:\Users\Nabin\Desktop\fortune-hundred\fortune_hundred\resources\views/layouts/master.blade.php ENDPATH**/ ?>